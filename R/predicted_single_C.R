...
predicted_single_C <- function(df, r1, sdss_legend, r2, cfs_legend, r3, r4, r5, r6, r7, r8, r9) {
  ...
  #pred_df %<>% mutate(percent_C = ifelse(percent_C > 6, 6, percent_C))
  ...
  pred_df %<>%
    rename_with(~paste("C_dwarf_birch"),
                .cols = percent_C)
  }
